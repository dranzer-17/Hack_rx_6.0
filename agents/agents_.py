...
from config.tools import reteriever_tool # Your simple tool
...
def get_reterival_agent(model_client):
    # This is the original, correct way for your library version.
    reterival_agent = AssistantAgent(
        ...
        tools = [reteriever_tool] # Pass the tool directly.
    )
